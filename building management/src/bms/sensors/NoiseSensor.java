...
public class NoiseSensor extends TimedSensor
     ...
     * https://www.iacacoustics.com/blog-full/comparative-examples-of-noise
     * -levels.html
    ...
    public int getComfortLevel() {
        double subtract = 1 - calculateRelativeLoudness();
        float result = (float) Math.floor(subtract * 100);
        if (result < 0) {
            return 0;
        } else {
            return (int) result;
